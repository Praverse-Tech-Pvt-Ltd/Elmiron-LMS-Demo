      ...
      <div style={{ flex: "1", padding: "8px 40px 32px", display: "grid", gridTemplateColumns: "minmax(0,1fr) 320px", gap: "28px", overflow: "hidden" }}>
        <div style={{ background: "#F1EFE8", borderRadius: "20px", display: "flex", alignItems: "center", justifyContent: "center", padding: "28px" }}>
          <div style={{ width: "800px", height: "566px", background: "#FFFFFF", borderRadius: "6px", boxShadow: "0 1px 2px rgba(20,21,15,.05),0 16px 40px -22px rgba(20,21,15,.35)", padding: "22px", boxSizing: "border-box" }}>
            <div style={{ height: "100%", border: "1px solid #E1DFD7", borderRadius: "4px", padding: "40px 48px", boxSizing: "border-box", display: "flex", flexDirection: "column" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}><div style={{ display: "flex", alignItems: "center", gap: "10px" }}><span style={{ width: "24px", height: "24px", borderRadius: "8px", background: "#35593A" }}></span><span style={{ fontSize: "15px", fontWeight: "600" }}>Elmiron Field · Learning</span></div><span style={{ fontFamily: "'Source Code Pro',monospace", fontSize: "13px", color: "#585B52" }}>ELM-LMS-2026-000123</span></div>
              <div style={{ fontSize: "14.5px", fontWeight: "500", color: "#585B52", marginTop: "44px" }}>Certificate of completion</div>
              <div style={{ fontSize: "40px", fontWeight: "600", letterSpacing: "-.022em", lineHeight: "1.1", marginTop: "6px" }}>Pratham Shrivastav</div>
              <div style={{ fontSize: "14.5px", color: "#585B52", marginTop: "2px" }}>Employee ID <span style={{ fontFamily: "'Source Code Pro',monospace", fontSize: "13.5px", color: "#1F211C" }}>EMP-40218</span> · Medical Representative, South Mumbai</div>
              <div style={{ fontSize: "15px", color: "#585B52", marginTop: "22px" }}>has completed</div>
              <div style={{ fontSize: "27px", fontWeight: "600", letterSpacing: "-.018em" }}>Elmiron — Product Training</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          <div className="card" style={{ background: "#FFFFFF", borderRadius: "20px", padding: "20px 22px", boxShadow: "0 1px 2px rgba(20,21,15,.05)" }}>
            ...
            <div style={{ fontFamily: "'Source Code Pro',monospace", fontSize: "13.5px", background: "#F1EFE8", borderRadius: "10px", padding: "10px 12px", marginTop: "10px" }}>ELM-LMS-2026-000123</div>
          </div>
