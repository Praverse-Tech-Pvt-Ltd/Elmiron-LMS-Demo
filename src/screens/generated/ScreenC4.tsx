...
export default function ScreenC4({ v }: { v: DemoValues }) {
  ...
  return (
    ...
    <div style={{ width: "224px", background: "#F1EFE8", padding: "22px 0", flex: "none", display: "flex", flexDirection: "column" }}>
      ...
      <div className="tap" style={{ padding: "9px 20px", fontSize: "14.5px", fontWeight: "600", color: "#35593A", background: "#E4EAE3", boxShadow: "inset 3px 0 0 #35593A", cursor: "pointer" }} onClick={v.go.c4}>Assign</div>
      <div className="tap h0" style={{ padding: "9px 20px", fontSize: "14.5px", color: "#585B52", cursor: "pointer" }} onClick={v.go.c5}>Reports</div>
    ...
    <div className="screen-main" style={{ flex: "1", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div style={{ flex: "1", padding: "0 30px 24px", overflow: "hidden", display: "flex", flexDirection: "column", gap: "14px" }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: "12px" }}><div style={{ fontSize: "24px", fontWeight: "600", letterSpacing: "-.03em" }}>Assign course</div><span style={{ fontSize: "14.5px", color: "#585B52" }}>Elmiron — Product Training · v2.1 · approved 18 Sep 2026</span></div>
        <div style={{ display: "grid", gridTemplateColumns: "minmax(0,1.15fr) minmax(0,1fr)", gap: "16px", flex: "1", minHeight: "0" }}>
          <div style={{ background: "#FFFFFF", borderRadius: "14px", boxShadow: "0 1px 2px rgba(20,21,15,.05)", display: "flex", flexDirection: "column", overflow: "hidden" }}>
            <div style={{ padding: "14px 18px", borderBottom: "1px solid #EFEDE6", display: "flex", alignItems: "flex-end", justifyContent: "space-between" }}>
              ...
              <div style={{ textAlign: "right" }}><div style={{ fontSize: "29px", fontWeight: "600", letterSpacing: "-.035em", lineHeight: "1", fontVariantNumeric: "tabular-nums" }}><CountUp to={String(v.audCount)} duration={500} /></div><div style={{ fontSize: "13px", color: "#585B52" }}>MRs selected</div></div>
            </div>
