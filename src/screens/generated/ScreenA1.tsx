      ...
      <div style={{ flex: "1", padding: "4px 40px 32px", display: "flex", flexDirection: "column", gap: "20px", overflow: "hidden" }}>
        ...
        <div style={{ background: "#1F211C", borderRadius: "20px", padding: "22px", display: "flex", gap: "28px", alignItems: "center", boxShadow: "0 14px 30px -20px rgba(20,21,15,.8)" }}>
          ...
          <div style={{ flex: "1", minWidth: "0" }}>
            ...
            <div style={{ fontSize: "27px", fontWeight: "600", letterSpacing: "-.035em", color: "#FFFFFF", lineHeight: "1.15" }}>Elmiron — Product Training</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) 340px", gap: "20px", flex: "1", minHeight: "0" }}>
          <div className="card" style={{ background: "#FFFFFF", borderRadius: "20px", overflow: "hidden", boxShadow: "0 1px 2px rgba(20,21,15,.05)" }}>
            <div style={{ padding: "16px 22px", borderBottom: "1px solid #F2F0E9", display: "flex", alignItems: "baseline", gap: "12px" }}><span style={{ fontSize: "16.5px", fontWeight: "600", letterSpacing: "-.01em" }}>Mandatory and due</span><span style={{ fontSize: "14.5px", color: "#585B52" }}>Overdue first, then by due date</span></div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", padding: "4px 2px 0" }}><span style={{ fontSize: "16.5px", fontWeight: "600", letterSpacing: "-.01em" }}>New courses</span><span className="tap" style={{ fontSize: "14.5px", fontWeight: "600", color: "#35593A", cursor: "pointer" }} onClick={v.go.a2}>Browse all courses</span></div>
