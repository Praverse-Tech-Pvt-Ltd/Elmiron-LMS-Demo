    ...
    <div className="screen-main" style={{ flex: "1", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div style={{ flex: "1", display: "flex", justifyContent: "center", padding: "40px 40px 32px" }}>
        <div style={{ width: "640px", display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <div><div style={{ fontSize: "14.5px", fontWeight: "500", color: "#585B52" }}>Final assessment · Elmiron — Product Training · v2.0</div><div style={{ fontSize: "30px", fontWeight: "600", letterSpacing: "-.018em" }}>You passed</div></div>
          <div className="card" style={{ background: "#FFFFFF", borderRadius: "20px", padding: "24px 26px", boxShadow: "0 1px 2px rgba(20,21,15,.04),0 16px 40px -22px rgba(20,21,15,.35)" }}>
            <div style={{ display: "flex", gap: "40px", alignItems: "flex-end", paddingBottom: "18px", borderBottom: "1px solid #F2F0E9" }}>
              <div><div style={{ fontSize: "13.5px", fontWeight: "500", color: "#585B52" }}>Your score</div><div style={{ fontSize: "40px", fontWeight: "600", letterSpacing: "-.022em", lineHeight: "1.05", color: "#35593A" }}><CountUp to="86%" /></div></div>
          ...
          <div style={{ background: "#E9F0E9", borderRadius: "16px", padding: "14px 18px", fontSize: "15px", lineHeight: "1.5" }}>The course is complete and your certificate <span style={{ fontFamily: "'Source Code Pro',monospace", fontSize: "14px" }}>ELM-LMS-2026-000123</span> is ready.</div>
