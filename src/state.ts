...
export function useDemo(go: (s: ScreenId | null) => void) {
  ...
  return useMemo(() => {
    ...
    const B1: [string, string, string, string, Pill, string, string, string, string][] = [
      ...
      ['rm', 'Rahul More', 'South Mumbai', 'Adverse Event Reporting for Field Staff', P('od', 'Overdue by 3 days'), 'Was due 21 Sep 2026', '0 of 3', 'Not started', 'Send reminder'],
